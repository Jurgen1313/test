...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        Player1Moves = new QLabel(centralWidget);
        Player1Moves->setObjectName(QStringLiteral("Player1Moves"));
        Player1Moves->setGeometry(QRect(220, 260, 131, 41));
        Player1Moves->setFont(font2);
        Player1Moves->setAlignment(Qt::AlignCenter);
        Player1Moves_2 = new QLabel(centralWidget);
        Player1Moves_2->setObjectName(QStringLiteral("Player1Moves_2"));
        Player1Moves_2->setGeometry(QRect(220, 310, 131, 41));
        Player1Moves_2->setFont(font2);
        Player1Moves_2->setAlignment(Qt::AlignCenter);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        Player1Moves->setText(QString());
        Player1Moves_2->setText(QString());
    } // retranslateUi
